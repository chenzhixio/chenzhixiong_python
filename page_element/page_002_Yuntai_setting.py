...
class test_Yuntai_setting(PageKey):
    ...
    def Yuntai_setting_001(self):
        try:
            ...
            for i in [1, 2, 3, 1]:
                ...
                sleep(3)
                distinguish1, distinguish2 = self.photo_video_distinguish("Yuntai_setting_003")
                self.operation_set_load(7)
                sleep(3)
                ...
                mylog.info(F"本次视频尺寸：{text}-------录像识别：{distinguish1}-----拍照识别：{distinguish2}")
    ...
    def Yuntai_setting_002(self):
        try:
            ...
            for i in [1, 2, 3, 4, 1]:
                ...
                self.driver.xpath(F'//android.widget.ListView/android.widget.LinearLayout[{i}]').click()
                sleep(3)
                distinguish1, distinguish2 = self.photo_video_distinguish("Yuntai_setting_002")
                self.operation_set_load(7)
                sleep(3)
                text = self.photo_size.get_text()
                mylog.info(F"本次照片分辨率：{text}-------录像识别：{distinguish1}-----拍照识别：{distinguish2}")
                distinguish_list.append(distinguish1)
                distinguish_list.append(distinguish2)
                text_list.append(text)
            self.driver.click(self.x, self.y)
    ...
    def Yuntai_setting_003(self):
        try:
            ...
            for i in [1, 2, 3, 1]:
                ...
                self.driver.xpath(F'//android.widget.ListView/android.widget.LinearLayout[{i}]').click()
                sleep(3)
                distinguish1, distinguish2 = self.photo_video_distinguish("Yuntai_setting_001")
                self.operation_set_load(7)
                sleep(3)
                ...
                distinguish_list.append(distinguish2)
                text_list.append(text)
                mylog.info(F"抗闪烁：{text}-------录像识别：{distinguish1}-----拍照识别：{distinguish2}")
            self.driver.click(self.x, self.y)
            return text_list, distinguish_list
        except BaseException as a:
            self.failed_operation()
    ...
    def Yuntai_setting_004(self):
        try:
            ...
            sleep(2)
            distinguish1 = self.photo_video_distinguish("Yuntai_setting_004")[0]
            self.operation_set_load(7)
            sleep(5)
            ...
            sleep(2)
            distinguish2 = self.photo_video_distinguish("Yuntai_setting_004")[0]
            self.operation_set_load(7)
            sleep(5)
    ...
    def Yuntai_setting_005(self):
        try:
            ...
            for i in [1, 2, 3, 1]:
                ...
                self.driver.xpath(F'//android.widget.ListView/android.widget.LinearLayout[{i}]').click()
                sleep(3)
                distinguish1, distinguish2 = self.photo_video_distinguish("Yuntai_setting_005", "分屏")
                self.operation_set_load(7)
                sleep(3)
                text = self.video_quality.get_text()
                text_list.append(text)
    ...
    def Yuntai_setting_006(self):
        try:
            ...
            for i in [1, 2, 3, 4, 1]:
                ...
                self.driver.xpath(F'//android.widget.ListView/android.widget.LinearLayout[{i}]').click()
                sleep(3)
                distinguish1, distinguish2 = self.photo_video_distinguish("Yuntai_setting_006", "分屏")
                self.operation_set_load(7)
                sleep(3)
                text = self.photo_size.get_text()
                mylog.info(F"本次照片分辨率：{text}-------录像识别：{distinguish1}-----拍照识别：{distinguish2}")
    ...
    def Yuntai_setting_007(self):
        try:
            ...
            for i in [1, 2, 3, 1]:
                ...
                self.driver.xpath(F'//android.widget.ListView/android.widget.LinearLayout[{i}]').click()
                sleep(3)
                distinguish1, distinguish2 = self.photo_video_distinguish("Yuntai_setting_008", "分屏")
                self.operation_set_load(7)
                sleep(3)
                text = self.anti_flicker.get_text()
                distinguish_list.append(distinguish1)
